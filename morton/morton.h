...
#ifndef C_UTILS_MORTON_H
#define C_UTILS_MORTON_H
...
C_UTILS_INLINE static inline u64 encode(u32 x) {
    u64 y = x;
...
C_UTILS_INLINE static inline __m256 encode_avx2(__m128 _x) {
 ...
 */
C_UTILS_INLINE static inline u64 morton_f32(f32 x, f32 min, f32 max) {
 ...
 * @return 64 bit encoded morton code. 
 */
C_UTILS_INLINE static inline u64 morton_u32(u32 x) {
